...
def check_outside():
    ...
    if st.session_state.show_outside:
                   ...
                   st.image("https://static.wikia.nocookie.net/limbuscompany/images/e/e2/Story_boat_cloudy2.png/revision/latest/scale-to-width-down/985?cb=20231120093636", caption="Limbus Company Canto V - The Great Lake")